...
public class FormKasir extends javax.swing.JFrame {
    ...
    public void first(){
        ...
        jLabel7.setText(user.getUserid());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        RubahPass n = new RubahPass(jLabel7.getText());
        n.setVisible(true);
        this.setVisible(false);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        ob.rubahprof(jLabel7.getText(), jTextField1.getText(), jTextField2.getText());
        jTextField1.setEnabled(false);
        jTextField2.setEnabled(false);
        jTextField1.setEnabled(false);
        jTextField2.setEnabled(false);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                if (user.getUserid() == null) {
                    login n = new login();
                    n.setVisible(true);
                    new FormKasir().setVisible(false);
                }else{
